package mx.edu.utez.fantasticoctoguacamole.utils;
...
public class OracleDatabaseConnectionManager {
    private static final String WALLET = "src/main/resources/Wallet/Wallet_ElectroStock";
    private static final String DB_NAME = "ElectroStock_high";
    private static final String DB_URL = "jdbc:oracle:thin:@" + DB_NAME + "?TNS_ADMIN=" + WALLET;
    private static final String DB_USER = "ADMIN";
    private static final String DB_PASSWORD = "El3cTr0St0Ck";
